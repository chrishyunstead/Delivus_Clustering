def isolate_white_clusters(df, group_name):
    ...
    while group_stack:
        ...
        if count_a >= 40 and count_b >= 40:
            ...
            print(
                f"→ 두 클러스터가 모두 40건 이상. 새로운 그룹 {new_group_a}, {new_group_b} 스택에 추가"
            )
        ...
        if 20 <= count_a < 40 and 20 <= count_b < 40:
            ...
            print(
                f"클러스터 초기 그룹 물량 20건이상 40건 미만이므로 그룹 {new_white_group_a}, {new_white_group_b} driver_type='WHITE'로 업데이트"
            )
            continue
        ...
        if 20 <= count_a < 40 and count_b >= 40:
            ...
            print("A 화이트 배정")
            print(
                f"클러스터 초기 그룹 물량 20건이상 40건 미만이므로 그룹 {new_white_group_a} driver_type='WHITE'로 업데이트"
            )
        ...
        if 20 <= count_b < 40 and count_a >= 40:
            ...
            print("B 화이트 배정")
            print(
                f"클러스터 초기 그룹 물량 20건이상 40건 미만이므로 그룹 {new_white_group_b} driver_type='WHITE'로 업데이트"
            )
